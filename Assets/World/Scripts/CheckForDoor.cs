...
public class CheckForDoor : MonoBehaviour {
	...
	void Start () {
        ...
        if(Physics.CheckSphere(posXCheck, radius))
        {
			...
			posX.transform.position = new Vector3(theRoom.transform.position.x + (roomSize/2), 10, theRoom.transform.position.z);
        ...
        if (Physics.CheckSphere(posZCheck, radius))
        {
			...
			posZ.transform.position = new Vector3(theRoom.transform.position.x, 10, theRoom.transform.position.z + (roomSize/2));
        ...
        if (Physics.CheckSphere(negXCheck, radius))
        {
			...
			negX.transform.position = new Vector3(theRoom.transform.position.x - (roomSize/2), 10, theRoom.transform.position.z);
        ...
        if (Physics.CheckSphere(negZCheck, radius))
        {
			...
			negZ.transform.position = new Vector3(theRoom.transform.position.x, 10, theRoom.transform.position.z - (roomSize / 2));
